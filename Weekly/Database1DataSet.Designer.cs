...
namespace Weekly {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class SignupDataTable : global::System.Data.TypedTableBase<SignupRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SignupRow AddSignupRow(int Id, string FirstName, string LastName, int Employee_ID, string Username, string Password) {
        ...
        public partial class SignupRow : global::System.Data.DataRow {
            ...
            public int Employee_ID {
                get {
                    try {
                        return ((int)(this[this.tableSignup.Employee_IDColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Employee_ID\' in table \'Signup\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableSignup.Employee_IDColumn] = value;
                }
            }
            ...
            public bool IsEmployee_IDNull() {
                return this.IsNull(this.tableSignup.Employee_IDColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetEmployee_IDNull() {
                this[this.tableSignup.Employee_IDColumn] = global::System.Convert.DBNull;
            }
...
namespace Weekly.Database1DataSetTableAdapters {
    ...
    public partial class SignupTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Signup] ([Id], [FirstName], [LastName], [Employee_ID], [Username], [Password]) VALUES (@Id, @FirstName, @LastName, @Employee_ID, @Username, @Password);
SELECT Id, FirstName, LastName, Employee_ID, Username, Password FROM Signup WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Signup] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName, [Employee_ID] = @Employee_ID, [Username] = @Username, [Password] = @Password WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Employee_ID = 1 AND [Employee_ID] IS NULL) OR ([Employee_ID] = @Original_Employee_ID)) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT Id, FirstName, LastName, Employee_ID, Username, Password FROM Signup WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Weekly.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Employee_ID, Username, Password FROM dbo.Signup";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Employee_ID, string Original_Username, string Original_Password) {
        ...
        public virtual int Insert(int Id, string FirstName, string LastName, global::System.Nullable<int> Employee_ID, string Username, string Password) {
        ...
        public virtual int Update(int Id, string FirstName, string LastName, global::System.Nullable<int> Employee_ID, string Username, string Password, int Original_Id, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Employee_ID, string Original_Username, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, global::System.Nullable<int> Employee_ID, string Username, string Password, int Original_Id, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Employee_ID, string Original_Username, string Original_Password) {
            return this.Update(Original_Id, FirstName, LastName, Employee_ID, Username, Password, Original_Id, Original_FirstName, Original_LastName, Original_Employee_ID, Original_Username, Original_Password);
        }
    }
